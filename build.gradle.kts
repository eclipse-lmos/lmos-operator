...
buildscript {
    dependencies {
        classpath("io.fabric8:crd-generator-api-v2:7.7.0")
        classpath("io.fabric8:crd-generator-collector:7.7.0")
    }
}

dependencies {
    val operatorFrameworkVersion = "6.4.3"
    ...
    implementation("org.eclipse.lmos:lmos-classifier-vector-spring-boot-starter:0.29.0")
    implementation("io.fabric8:generator-annotations:$fabric8Version")
