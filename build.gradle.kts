...
dependencies {
    ...
    implementation("io.javaoperatorsdk:operator-framework-spring-boot-starter:6.1.1")
    ...
    testImplementation("io.javaoperatorsdk:operator-framework-spring-boot-starter-test:6.1.1") {
